...
function redirect(){
    if(document.getElementById("username").value == 'sammy' && document.getElementById("psw").value == 'SAmmY101' ){
        alert("Login Successful");
        setTimeout(function() {window.location = "detail.php"});
    }else{
...
<div class="container">
  ...
  <input type="password"class="form-control"  name="pass" placeholder="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
					...
					<div class="form-group">
						<input class="btn float-right login_btn" type="submit" name="save" value="Login" >
					</div>
